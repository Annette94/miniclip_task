...
-ifndef(dynamodbtask_pb).
-define(dynamodbtask_pb, true).

-define(dynamodbtask_pb_gpb_version, "3.26.4").

-ifndef('DATA_PB_H').
-define('DATA_PB_H', true).
-record(data,
        {key                    :: binary() | iolist(), % = 1
         value                  :: binary() | iolist() % = 2
        }).
-endif.
...
-record(req_envelope,
        {type                   :: 'set_request_t' | 'set_response_t' | 'get_request_t' | 'get_response_t' | integer(), % = 1, enum req_envelope.msg_type
         set_req                :: #set_request{} | undefined, % = 2
         set_resp               :: #set_response{} | undefined, % = 3
         get_req                :: #get_request{} | undefined, % = 4
         get_resp               :: #get_response{} | undefined % = 5
        }).
-endif.
